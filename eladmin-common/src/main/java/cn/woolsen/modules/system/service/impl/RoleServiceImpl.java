...
import cn.woolsen.modules.system.service.mapstruct.RoleMapper;
import cn.woolsen.modules.system.service.mapstruct.RoleSmallMapper;
...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public Set<AuthorityDto> mapToGrantedAuthorities(UserDto user) {
        ...
        return roleRepository.findByUserId(user.getId()).stream()
    ...
    @Override
    public Set<AuthorityDto> mapToGrantedAuthorities(User user) {
        Set<String> permissions = new HashSet<>();
        // 如果是管理员直接返回
        if (user.getIsAdmin()) {
            permissions.add("admin");
