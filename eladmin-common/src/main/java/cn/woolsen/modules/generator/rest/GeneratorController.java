 ...
 */
package cn.woolsen.modules.generator.rest;
...
import cn.woolsen.modules.generator.service.GenConfigService;
import cn.woolsen.modules.generator.service.GeneratorService;
...
public class GeneratorController {
    ...
    public ResponseEntity<PageDTO<ColumnInfo>> queryColumns(@RequestParam String tableName) {
        List<ColumnInfo> columnInfos = generatorService.getColumns(tableName);
        return new ResponseEntity<>(PageUtil.toPage(columnInfos, (long) columnInfos.size()), HttpStatus.OK);
    }
